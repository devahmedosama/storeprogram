...
@section('content')
	<div class="page-header">
        <h2 class="header-title">{{ trans('home.Stores') }}  </h2>
        <div class="header-sub-title">
            <nav class="breadcrumb breadcrumb-dash">
                <a href="{{ URL::to('admin') }}" class="breadcrumb-item">
					<i class="anticon anticon-home m-r-5"></i>{{ trans('home.Home') }} </a>

                <a href="{{ URL::to('admin/stores') }}" class="breadcrumb-item">{{ trans('home.Stores') }} </a>
	...
	<div class="card">
		<div class="card-body">
			<div class="table-responsive">
				<a href="{{ URL::to('admin/stores/add') }}" 
			    ...
			    <table class="table">
			        ...
			        <tbody>
			            ...
			            <tr>
			                ...
			                <td>
			                	<a href="{{ URL::to('admin/stores/edit/'.$data->id) }}" 

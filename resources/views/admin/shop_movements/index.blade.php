	...
	<div class="page-header">
        ...
        <div class="header-sub-title">
            <nav class="breadcrumb breadcrumb-dash">
                ...
                <a href="{{ URL::to('admin/shop-movements') }}" class="breadcrumb-item">
                    {{ trans('home.Shop Movements') }}</a>
	...
	<div class="card">
		<div class="card-body">
			<div class="table-responsive">
				<a href="{{ URL::to('admin/shop-movements/add') }}"
			    ...
			    <table class="table">
			        ...
			        <tbody>
			            ...
			            <tr>
                            ...
                            <td>
                                <a href="{{ URL::to('admin/shop-movements/view/'.$data->id) }}" title="{{ trans('home.View') }}" class="popup-link btn btn-xs btn-primary">
                                    <i class="anticon anticon-eye"></i>
                                </a>
                                <a href="{{ URL::to('admin/shop-movements/edit/'.$data->id) }}" title="{{ trans('home.Update') }}" 

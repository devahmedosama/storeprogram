...
@section('content')
	<div class="page-header">
        <div class="header-sub-title">
            <nav class="breadcrumb breadcrumb-dash">
                ...
                <a class="breadcrumb-item" href="{{ URL::to('admin/stock-movements') }}">{{ trans('home.Stock Movements') }}</a>
	...
	<div class="card">
		<div class="card-body">
			{{ Form::open(['url'=>'admin/stock/move','files'=>true,'enctype'=>'multipart','id'=>'signatureForm']) }}
			    ...
			    <div class="form-row">
					...
					<div class="form-group col-md-6 ">
			            <label for="inputEmail4">{{ trans('home.Store To') }}</label>
			            {{ Form::select('store_to',$stores,null,['class'=>'form-control','required','placeholder'=>trans('home.Choose Store')
							]) }}
			        </div>

	...
	<div class="page-header">
        ...
        <div class="header-sub-title">
            <nav class="breadcrumb breadcrumb-dash">
                ...
                <a href="{{ URL::to('admin/stock-movements') }}" class="breadcrumb-item">
                    {{ $title }}</a>
	...
	<div class="card">
		<div class="card-body">
			<div class="table-responsive">
				<a href="{{ URL::to('admin/stock-movements/move') }}"
			    ...
			    <table class="table">
			        ...
			        <tbody>
			            ...
			            <tr>
                            ...
                            <td>
                                <a href="{{ URL::to('admin/stock-movements/view/'.$data->id) }}" title="{{ trans('home.View') }}" class="popup-link btn btn-xs btn-primary">

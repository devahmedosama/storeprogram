...
@section('content')
	...
	<div class="card">
		<div class="card-body">
			{{ Form::open(['url'=>'admin/ask-bills/edit/'.$data->id,'files'=>true,'enctype'=>'multipart','id'=>'signatureForm']) }}
			    
			    <div class="form-row">
					<div class="form-group col-md-6 ">
			            <label for="inputEmail4">{{ trans('home.Store') }}</label>
			            {{ Form::select('store_id',$stores,$data->store_id,['class'=>'form-control','required'
							]) }}
			        </div>
				    <div class="form-group col-md-6 ">

	...
	<div class="page-header">
        ...
        <div class="header-sub-title">
            <nav class="breadcrumb breadcrumb-dash">
                ...
                <a href="{{ URL::to('admin/ask-bills') }}" class="breadcrumb-item">
			    ...
			    <table class="table">
			        ...
			        <tbody>
			            ...
			            <tr>
                            ...
                            <td>
                                <a href="{{ URL::to('admin/ask-bills/view/'.$data->id) }}" title="{{ trans('home.View') }}" class="popup-link btn btn-xs btn-primary">
                                    <i class="anticon anticon-eye"></i>
                                </a>
                                <a href="{{ URL::to('admin/ask-bills/edit/'.$data->id) }}" title="{{ trans('home.Update') }}" 

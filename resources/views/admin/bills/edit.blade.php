...
@section('content')
	<div class="page-header">
        <div class="header-sub-title">
            <nav class="breadcrumb breadcrumb-dash">
                ...
                <a class="breadcrumb-item" href="{{ URL::to('admin/sales-bills') }}">{{ trans('home.Sales Bills') }}</a>
	...
	<div class="card">
		<div class="card-body">
			{{ Form::open(['url'=>'admin/sales-bills/edit/'.$data->id,'files'=>true,'enctype'=>'multipart','id'=>'signatureForm']) }}
			    ...
			    <div class="form-row">
					...
					<div class="form-group col-md-6 plus_div">
			            ...
			            {{ Form::select('sales_man_id',$items,$data->sales_man_id,['class'=>'form-control','required'
							,'id'=>'sales_man_id']) }}

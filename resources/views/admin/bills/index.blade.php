	...
	<div class="card">
		<div class="card-body">
			<div class="table-responsive">
				<a href="{{ URL::to('admin/sales-bills/add') }}" class="btn-xs btn btn-primary pull-right">
			    ...
			    <table class="table">
			        ...
			        <tbody>
			            ...
			            <tr>
                            ...
                            <td>
                                <a href="{{ URL::to('admin/sales-bills/view/'.$data->id) }}" title="{{ trans('home.View') }}" class="popup-link btn btn-xs btn-primary">
                                    <i class="anticon anticon-eye"></i>
                                </a>
                                <a href="{{ URL::to('admin/sales-bills/edit/'.$data->id) }}" title="{{ trans('home.Update') }}" 
